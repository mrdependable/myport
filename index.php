...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<h1 style="color:#fff;"><b>Coming Soon!!</b></h1>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
		<section class="slogan fade-down">
			<h1>This website is under construction. It'll be here soon with our new awesome site, subscribe to be notified.</h1>			
		</section>
		<!-- Slogan end here -->
		...
		<section class="newsletter row fade-down">      
            ...
            <form action="//koding.us11.list-manage.com/subscribe/post?u=f26ba51ec379a89273f74f060&amp;id=324fa48f77" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="contact col-md-6 fade-down validate" target="_blank" novalidate>
            <div id="mc_embed_signup_scroll" class="form-group">
            	<div>
	                <span class="user-ico"> <i class="fa fa-user"></i> </span>
	            	<input style="padding: 0 22% 0 70px;" type="text" autofocus required name="NAME" placeholder="Enter your name here to stay tuned">
            	</div><br>
                <div>
	                <span class="email-ico"> <i class="fa fa-envelope-o"></i> </span>
	            	<input type="email" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Enter your email here to stay tuned">
            	</div>
		...
		<ul class="connect-us row fade-down">
			<li><a href="//facebook.com/profile.php?id=100004092831188" class="fb tool-tip" title="Facebook"><i class="fa fa-facebook"></i></a></li>
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; 2015, All Rights Reserved.</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="jyotish@scientist.com"; // Add your e-mail here
        	if($code!=$captcha){
